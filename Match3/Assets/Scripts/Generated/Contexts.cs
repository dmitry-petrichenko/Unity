...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, IntVector2D>(
            Position,
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithPosition(this GameContext context, IntVector2D value) {
        return ((Entitas.EntityIndex<GameEntity, IntVector2D>)context.GetEntityIndex(Contexts.Position)).GetEntities(value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
